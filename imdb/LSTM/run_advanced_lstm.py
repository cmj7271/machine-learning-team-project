...
def run_lstm_experiment(X, y):
    ...
    if response.lower() == 'y':
        ...
        # 결과 저장
        with open('advanced_lstm_results.json', 'w') as f:
            json.dump(lstm_results, f, indent=2)
        print("\n✅ LSTM 결과가 'advanced_lstm_results.json'에 저장되었습니다.")
...
def compare_models(lstm_results):
    ...
    try:
        ...
        # 비교 분석
        from advanced_lstm import compare_with_mlp
